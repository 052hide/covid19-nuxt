<template>
  ...
  <div v-else class="recovered-page">
    <section>
      <div class="recovered__top">
        <h1 class="recovered__title">Recovered</h1>
      </div>
      <div class="recovered__main">
      ...
      <div class="recovered__bottom">
        <div
          v-for="(country, index) in countries"
          :key="index"
          class="recovered__checkboxes"
        >
          <input
